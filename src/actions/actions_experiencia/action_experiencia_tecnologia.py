...
class ActionExperienciaTecnologia(Action):
    ...
    def run(self, dispatcher: CollectingDispatcher,
        ...
        # Caso especial: si el usuario dice "todas"
        if tecnologia == "todas":
            dispatcher.utter_message(text="Puedo contarte sobre toda mi experiencia: React, Next.js, Node.js/NestJS, TypeScript, Tailwind, Docker, PostgreSQL, React Native y más.")
        ...
        if empresas_con_tecnologia:
            ...
            # Caso cuando la tecnología no está en tu historial
            mensaje = (
                f"No tengo experiencia con **{tecnologia.title()}** en mi historial laboral.\n"
                f"Tengo experiencia con React/Nextjs, Nodejs/Nestjs y otras tecnologías. "
                "¿Deseas conocerlas?"
            )
